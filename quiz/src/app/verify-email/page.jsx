      ...
      <Card className="w-full max-w-lg p-8 text-center">
        ...
        {status === "success" && (
          <>
            ...
            <p className="mt-3 text-sm text-muted-foreground">You can now log in to your student account.</p>
        ...
        {status === "error" && (
          <>
            ...
            <Button className="mt-6 w-full" variant="outline" onClick={() => router.push("/signup")}>Back to Sign Up</Button>
          </>
        )}
      </Card>
    </main>
